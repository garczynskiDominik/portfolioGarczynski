                    ...
                    <div id="contact" class="box-shadow-full">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="more-info">
                                    <p class="lead">
                                        My name is Dominik... This webapplication shows my achievements so far. After logging in as admin role, the user will have extra options, add, modify, delete date in every each one tab. Everything is connected to the Postgres database.
                                    </p>
                                    <ul class="list-ico">
